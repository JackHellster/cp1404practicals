...
def main():
    ...
    print(f"Tried driving 115 km. Actual distance traveled: {distance_driven}")

    distance_driven = limo.drive(100)
    print(f"Limo odometer: {limo.odometer}")
    print(f"Tried driving 100 km. Actual distance traveled: {distance_driven}")
